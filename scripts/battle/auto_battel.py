...
def auto_battle(current_chapter, battle_id=1):
    ...
    while True:
        ...
        sleep(1)
        if exists(Template(r"tpl1741774376650.png", threshold=0.6, rgb=True, record_pos=(0.172, 0.033),
                           resolution=(1260, 2720))):
            touch(Template(r"tpl1741774376650.png", threshold=0.6, rgb=True, record_pos=(0.172, 0.033),
                           resolution=(1260, 2720)))
        auto_read_dialog()
            ...
            while True:  # 战斗会自动攻击，等待战斗胜利
                try:
                    if exists(Template(r"tpl1741758903634.png", threshold=0.7, record_pos=(0.019, -0.156),
                                       resolution=(1260, 2720))):
                        touch(Template(r"1741774789648.png", threshold=0.8, record_pos=(0.22, -0.62),
                                       resolution=(1260, 2720)))
                        break
